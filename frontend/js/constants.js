const contractAddress = "0xb456DE0Fa1D302A74E89445fef72A44835AcC6D2"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Citizen NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Citizen NFT Project is a game, where player move up the rank';
